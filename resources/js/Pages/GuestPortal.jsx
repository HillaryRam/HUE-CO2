            ...
            {view === 'select_mode' && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="w-full max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <button onClick={() => handleSelectMode('solo')} className="bg-white border-4 border-[#e7e5e4] p-6 rounded-[2.5rem] text-left hover:border-[#16a34a] hover:bg-[#f0fdf4] transition-all group shadow-sm hover:shadow-xl flex flex-col items-start h-full">
                        ...
                        <button onClick={() => handleSelectMode('small')} className="bg-white border-4 border-[#e7e5e4] p-6 rounded-[2.5rem] text-left hover:border-[#fb923c] hover:bg-[#fff7ed] transition-all group shadow-sm hover:shadow-xl flex flex-col items-start h-full">
                        ...
                        <button onClick={() => handleSelectMode('classic')} className="bg-white border-4 border-[#e7e5e4] p-6 rounded-[2.5rem] text-left hover:border-[#3b82f6] hover:bg-[#eff6ff] transition-all group shadow-sm hover:shadow-xl flex flex-col items-start h-full">
                        ...
                        <button onClick={() => handleSelectMode('class')} className="bg-white border-4 border-[#e7e5e4] p-6 rounded-[2.5rem] text-left hover:border-[#d946ef] hover:bg-[#fdf4ff] transition-all group shadow-sm hover:shadow-xl flex flex-col items-start h-full">
